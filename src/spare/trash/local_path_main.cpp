...
{   
    ...
    double thresh_a = 0.05;
    auto node = std::make_shared<LocalPathPlanner>(max_v, v_resolution, max_omega, omega_resolution, direction_gain_, speed_gain_, obstacle_gain_, dt, boundary, thresh_d, thresh_a);
    rclcpp::spin(node);
    rclcpp::shutdown();
